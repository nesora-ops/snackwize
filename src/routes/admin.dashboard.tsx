...
import { AdminGuard } from "@/components/sections/RouteGuard";
...
export const Route = createFileRoute("/admin/dashboard")({
  head: () => ({ meta: [{ title: "Admin · Snackwize" }, { name: "robots", content: "noindex" }] }),
  component: () => <AdminGuard><AdminPanel /></AdminGuard>,
});
...
function AdminPanel() {
  ...
  const logoutAdmin = () => { setAdmin(false); nav({ to: "/admin/login" }); };
