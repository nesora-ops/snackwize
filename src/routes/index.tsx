...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Snackwize — Homemade Healthy Snacks Delivered Pan India" },
      { name: "description", content: "Guilt-free homemade baked snacks from Mumbai. Granola bars, cookies, energy bites — no preservatives, baked not fried." },
      { property: "og:title", content: "Snackwize — Homemade Healthy Snacks" },
      { property: "og:description", content: "Guilt-free baked snacks handmade in Mumbai. Delivered Pan India." },
    ],
  }),
  component: Index,
});
    ...
    <SiteLayout>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-6 py-20 md:grid-cols-2 md:py-28 md:gap-6">
          <div className="flex flex-col justify-center">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="mt-8 flex flex-wrap gap-3">
              <Link to="/menu" className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/30 transition hover:bg-primary-dark">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="mb-10 flex items-end justify-between gap-4">
          ...
          <Link to="/menu" className="hidden text-sm font-semibold text-primary hover:text-primary-dark md:inline-flex">View full menu →</Link>
        </div>
      ...
      <section className="bg-surface">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 md:grid-cols-2 md:items-center">
          <div className="relative">
            <img src={PRODUCTS[2].image} alt="Snacks" className="aspect-[4/5] w-full rounded-3xl object-cover" />
          ...
          <div>
            ...
            <Link to="/about" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-foreground hover:text-primary">
