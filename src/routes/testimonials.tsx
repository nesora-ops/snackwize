...
export const Route = createFileRoute("/testimonials")({
  head: () => ({
    meta: [
      { title: "Testimonials — Snackwize" },
      { name: "description", content: "What 500+ Snackwize customers across India have to say." },
      { property: "og:title", content: "Snackwize Testimonials" },
      { property: "og:description", content: "Real love from real customers across India." },
    ],
  }),
