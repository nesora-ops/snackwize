...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Snackwize" },
      { name: "description", content: "Meet Nupur, the founder of Snackwize, and the story behind India's most-loved homemade snack brand." },
      { property: "og:title", content: "About Snackwize" },
      { property: "og:description", content: "Hi! I'm Nupur. This is why I started Snackwize." },
    ],
  }),
  component: About,
});
    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          <img src={PRODUCTS[7].image} alt="Snackwize kitchen" className="aspect-[4/5] w-full rounded-3xl object-cover" />
          <div>
